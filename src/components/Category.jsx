...
const Category = () => {
  ...
  const categoryImages = {
    "men's clothing": mobileImg,
    "women's clothing": laptopImg,
    "jewelery": audioImg,
    "electronics": tvImg,
  };
  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Responsive grid: 2 on mobile, 4 on larger screens to fill space evenly */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {categoryOnlyData
          ...
          .map((cat, index) => (
            ...
            >
              <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 flex items-center justify-center mb-3 hover:scale-110 transition-transform">
                <img
